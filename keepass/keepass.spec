...
find . -name "*.csproj" -print -exec sed -i 's/<TargetFrameworkVersion>.*</TargetFrameworkVersion>//g' {} \;
find . -name "*.csproj" -print -exec sed -i 's/<PropertyGroup>/<PropertyGroup><TargetFrameworkVersion>v4.5</TargetFrameworkVersion>/g' {} \;
